<template>
    <Default>
        <Head :title="t('admin.tracks.edit')" />
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="mt-2" :style="{ color: themeColor.primary }" :class="{ 'rtl': isRTL }">
                            {{ t('admin.tracks.edit_description') }}
                        </p>
                    </div>
                    <Link :href="route('track-supervisor.tracks.index')"
...
const form = useForm({
    ...
    hackathon_id: props.track?.hackathon_id || '',
...
// Methods
const submit = () => {
    form.put(route('track-supervisor.tracks.update', props.track.id))
}
