<template>
    ...
    <Default>
        <div class="w-full h-full overflow-hidden bg-gray-50 dark:bg-gray-900" :style="themeStyles">
            ...
            <div v-else class="w-full overflow-hidden flex flex-col items-start justify-start max-w-[960px] mx-auto">
                <!-- Team Header -->
                <div class="self-stretch flex flex-row items-start justify-between flex-wrap content-start p-4">
                    <div class="flex flex-col items-start justify-start gap-3 min-w-[288px]">
                        ...
                        <div class="flex flex-col items-start justify-start text-sm"
                            ...
                            <div class="relative leading-[21px]">Led by {{ team.leader?.name || 'TBA' }}</div>
                        </div>
                    </div>
                </div>
                
                <!-- Members Header -->
                <div class="self-stretch flex flex-col items-start justify-start pt-4 px-4 pb-2">
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Members</h2>
                </div>
                
                <!-- Members Table -->
                <div class="self-stretch flex flex-col items-start justify-start py-3 px-4">
                    <div class="self-stretch rounded-xl border overflow-hidden"
                        :style="{ borderColor: themeColor.primary + '30', backgroundColor: themeColor.primary + '05' }">
                        <div class="flex-1 flex flex-col items-start justify-start">
                            <!-- Table Header -->
                            <div class="self-stretch bg-white dark:bg-gray-800 border-b flex flex-col items-start justify-start"
                                :style="{ borderColor: themeColor.primary + '20' }">
                                <div class="self-stretch flex flex-row items-start justify-between"
                                    :style="{ backgroundColor: themeColor.primary + '10' }">
                                    <div class="w-[210px] py-3 px-4">
                                        <div class="text-sm font-medium text-gray-700 dark:text-gray-300">Name</div>
                                    </div>
                                    <div class="w-[200px] py-3 px-4">
                                        <div class="text-sm font-medium text-gray-700 dark:text-gray-300">E-mail</div>
                                    </div>
