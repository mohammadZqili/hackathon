    ...
    <Default>
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="max-w-2xl mx-auto">
                <!-- Header -->
                <div class="mb-8">
                    <h1 class="text-3xl font-bold text-gray-900">Create New Track</h1>
                    <p class="mt-2 text-gray-600">Add a new track for {{ edition?.name }}</p>
                </div>
...
const submit = () => {
    form.post(route('hackathon-admin.tracks.store'));
};
</script>