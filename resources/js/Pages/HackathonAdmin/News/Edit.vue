...
const getMainImageFiles = () => {
    if (!props.article?.featured_image_path) {
        return [];
    }
    return [{
        source: `/storage/${props.article.featured_image_path}`,
        options: { type: 'local' }
    }];
}

const getGalleryFiles = () => {
    const gallery = props.article?.seo_data?.gallery_images || [];
    ...
    <Default>
        <div class="container mx-auto px-4 py-8" :style="themeStyles">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Edit News Article</h1>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="lg:col-span-2">
                            <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">News Title</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Video Embedding -->
                        <div>
                            <label for="video_url" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Video Embedding</label>
                            <div class="space-y-2">
                                <label class="text-xs text-gray-600 dark:text-gray-400">Video URL</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Twitter Message -->
                        <div>
                            <label for="twitter_message" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Twitter Message</label>
                        ...
                        <!-- Twitter Publishing -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Twitter Publishing</label>
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                <div class="flex items-center justify-between">
                                    <span class="text-sm text-gray-700 dark:text-gray-300">Publish to Twitter</span>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="max-w-xl">
                            <div class="border border-gray-300 dark:border-gray-600 rounded-lg p-3 bg-gray-50 dark:bg-gray-800">
                                ...
                                />
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Upload up to 10 images. JPG, PNG, or WebP</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- SEO Keywords -->
                    <div>
                        <label for="keywords" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">SEO Keywords</label>
