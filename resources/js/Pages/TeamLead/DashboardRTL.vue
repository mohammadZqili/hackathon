<template>
    <Head :title="t('dashboard') + ' - ' + t('team_lead')" />
    <Default>
        <div class="container mx-auto px-4 py-8" :style="themeStyles" :dir="direction">
            <!-- Page Header -->
            <div class="mb-8">
                <h1 class="text-[32px] font-bold text-gray-900 dark:text-white leading-10" 
            ...
            <!-- Summary Section -->
            <div class="mb-6">
                <h2 class="text-[22px] font-bold text-gray-900 dark:text-white leading-7 mb-5"
                    :class="isRTL ? 'text-right' : 'text-left'">
                    {{ t('summary') }}
                </h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white" :class="isRTL ? 'text-right' : 'text-left'">
                        {{ stats.team_members || 0 }}
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400" :class="isRTL ? 'text-right' : 'text-left'">
                        {{ t('team_members') }}
                    </p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white" :class="isRTL ? 'text-right' : 'text-left'">
                        {{ stats.track || t('not_selected') }}
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400" :class="isRTL ? 'text-right' : 'text-left'">
                        {{ t('current_track') }}
                    </p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm">
                    ...
                    <h3 class="text-2xl font-bold text-gray-900 dark:text-white" :class="isRTL ? 'text-right' : 'text-left'">
                        {{ stats.workshops_registered || 0 }}
                    </h3>
                    <p class="text-sm text-gray-600 dark:text-gray-400" :class="isRTL ? 'text-right' : 'text-left'">
                        {{ t('workshops_registered') }}
                    </p>
                </div>
            </div>
        </div>
