...
const viewEditionReport = (editionId) => {
    ...
    if (edition) {
        ...
        router.get(route('system-admin.reports.index', { edition_id: editionId }), {}, {
            preserveState: true,
            preserveScroll: true,
...
const exportData = () => {
    ...
    let url = route('system-admin.reports.export')
    let params = {}
...
const backToOverall = () => {
    ...
    window.history.replaceState({}, document.title, route('system-admin.reports.index'))
}
