...
<template>
    <Head :title="t('admin.news.edit')" />
    <Default>
        <div class="container mx-auto px-4 py-8" :style="themeStyles">
            <!-- Page Header -->
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">{{ t('admin.news.edit') }}</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">
                        {{ t('admin.news.edit_description') }}
                    </p>
                </div>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700">
                    <div class="flex gap-8 px-6">
                        <button class="py-4 px-1 border-b-2 transition-colors border-[var(--theme-primary)] text-[var(--theme-primary)]">
                            <span class="text-sm font-medium">{{ t('admin.news.edit') }}</span>
                        </button>
                        <Link :href="route('system-admin.news.index')"
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex justify-center pt-4">
                        <button type="submit"
                            ...
                            {{ form.processing ? t('admin.actions.updating') : t('admin.news.update_article') }}
                        </button>
                    </div>
                </div>
            </form>
