...
const form = useForm({
    ...
    linkedin: props.organization?.linkedin || '',
...
watch(() => props.organization, (newOrg) => {
    if (newOrg) {
        ...
        form.contact_email = newOrg.contact_email || ''
        form.contact_phone = newOrg.contact_phone || ''
        form.website = newOrg.website || ''
        form.address = newOrg.address || ''
        form.type = newOrg.type || ''
        form.industry = newOrg.industry || ''
        form.logo_url = newOrg.logo_url || ''
        form.linkedin = newOrg.linkedin || ''
        form.twitter = newOrg.twitter || ''
    }
})
