...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | تحتوي الأسطر التالية على رسائل الخطأ الافتراضية المستخدمة
    | بواسطة فئة المدقق. بعض هذه القواعد لها إصدارات متعددة مثل
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | يتم استخدام الأسطر التالية لاستبدال العنصر النائب للسمة
    | بشيء أكثر سهولة للقارئ مثل "عنوان البريد الإلكتروني" بدلاً
    | من "email". هذا يساعدنا ببساطة في جعل رسائلنا أكثر تعبيرًا.
    |
    */
