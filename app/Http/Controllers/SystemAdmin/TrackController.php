...
class TrackController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('SystemAdmin/Tracks/Index', [
            'tracks' => $tracks,
            'editions' => $editions,
    ...
    public function create(): Response
    {
        ...
        return Inertia::render('SystemAdmin/Tracks/Create', [
            'editions' => $editions,
        ]);
    }
    ...
    public function show(Track $track): Response
    {
        ...
        return Inertia::render('SystemAdmin/Tracks/Show', [
            'track' => $track,
        ]);
    }
    ...
    public function edit(Track $track): Response
    {
        ...
        return Inertia::render('SystemAdmin/Tracks/Edit', [
            'track' => $track,
            'editions' => $editions,
        ]);
    }
