...
class SpeakerController extends Controller
{
    public function index()
    {
        ...
        return Inertia::render('HackathonAdmin/Speakers/Index', [
            'speakers' => $speakers
        ]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render('HackathonAdmin/Speakers/Create', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('hackathon-admin.speakers.index')
            ->with('success', 'Speaker created successfully.');
    }

    public function show(Speaker $speaker)
    {
        return Inertia::render('HackathonAdmin/Speakers/Show', [
            'speaker' => $speaker
        ]);
    }
    ...
    public function edit(Speaker $speaker)
    {
        ...
        return Inertia::render('HackathonAdmin/Speakers/Edit', [
            'speaker' => $speaker,
            'organizations' => $organizations,
            'workshops' => $workshops
        ]);
